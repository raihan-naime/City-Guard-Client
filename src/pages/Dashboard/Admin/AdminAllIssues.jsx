...
const AdminAllIssues = () => {
  ...
  const handleAssign = async () => {
    ...
    try {
      await axiosSecure.patch(`/issues/${selectedIssue._id}/assign`, {
        ...
        <table className="table w-full text-left rounded-lg overflow-hidden shadow-md">
          ...
          <tbody>
            {issues.map((issue) => (
              <tr
                key={issue._id}
                className="even:bg-gray-100 hover:bg-purple-50"
              >
                ...
                <td className="p-3">
                  ...
                  / <span className="text-blue-600">{issue.priority}</span>
                </td>
                <td className="p-3">
                  {issue.assignedTo ? (
          ...
          >
            ...
            >
              ...
              <div className="form-control w-full mb-6">
                ...
                <select
                  className="select bg-gray-100 select-bordered w-full"
              ...
              <button onClick={handleAssign} className="btn btn-primary w-full">
                Confirm Assignment
              </button>
            </motion.div>
          </motion.div>
