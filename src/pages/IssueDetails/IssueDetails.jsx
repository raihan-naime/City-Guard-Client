...
const IssueDetails = () => {
  ...
  console.log(user?.email, issue.author?.email);
        ...
        >
          <div className="relative group overflow-hidden rounded-2xl shadow-2xl mb-8">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-8">
              <div>
                <h1 className="text-4xl bg-white px-2 font-bold text-white mb-2 drop-shadow-md">
                  {issue.title}
                </h1>
                <div className="flex flex-wrap gap-3">
                  <span
                    className={`badge border-none text-white font-semibold py-3 px-4 ${
            ...
            <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
              <div className="avatar">
                <div className="w-14 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                  <img
                    src={
                      issue.author?.photoURL ||
                      "https://i.ibb.co/SwfJhQgj/image.png"
                    }
                    alt="User"
                  />
                </div>
              ...
              <div className="ml-auto flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-lg font-bold text-gray-700">
                <FcLike /> {issue.upvoteCount} Upvotes
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mt-6">
              ...
              {user?.email === issue?.email && issue.status === "pending" && (
                <button
                  ...
                  className="btn btn-warning gap-2 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all"
                >
                  <FaEdit /> Edit Issue
                </button>
              )}
              ...
              {user?.email === issue?.email && (
                <button
                  ...
                  className="btn btn-error text-white gap-2 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all"
                >
                  <FaTrash /> Delete
                </button>
              )}
              ...
              {issue.priority !== "high" && (
                <button
                  ...
                  className="btn btn-secondary gap-2 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all bg-gradient-to-r from-violet-600 to-fuchsia-600 border-none animate-pulse hover:animate-none"
                >
                  ...
                  <div key={index} className="relative pl-8 pb-3 last:pb-0">
                    ...
                    <div className="flex flex-col bg-gray-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span className="text-xs lg:ml-2 text-gray-500 font-mono bg-white px-2 py-1 rounded-full shadow-sm">
                      ...
                      <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
                        <FaUserCircle /> updated by: {event.updatedBy}
                      </p>
                    </div>
                  </div>
                ))}
        ...
        {isPaymentModalOpen && (
          <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">
                Boost Issue Priority
              </h3>
              <p className="mb-6 text-center text-gray-600 bg-purple-50 p-4 rounded-xl border border-purple-100">
                Upgrade this issue to <strong>High Priority</strong> for faster
                resolution.
                <br />
                <span className="text-sm">
                  Cost:{" "}
                  <strong className="text-purple-700 text-lg">100 Tk</strong>{" "}
                  ($1)
                </span>
              </p>
